...
function Database(){
    ...
    return(
    <div class="container-fluid"> <h1>STUDENT INFORMATION</h1>
        <div className="container-md ">
            ...
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <button class="nav-link" id="nav-admin-tab" data-bs-toggle="tab" data-bs-target="#nav-admin" type="button" role="tab" aria-controls="nav-admin" aria-selected="false">Admin Information</button>
            ...
            <div className="row">
                <div className="col">
                    <div class="input-group mb-1">
                        ...
                        <select class="form-select" id="inputGroupSelect01">
                            <option selected>Select</option>
                            <option value="ADBasicInformation">Alphabatetically</option>
